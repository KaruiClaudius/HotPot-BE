...
namespace Capstone.HPTY.API.Controllers.Manager
{
    ...
    public class ManagerEquipmentConditionsController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<ConditionLog>>> CreateConditionLog([FromBody] ConditionLog conditionLog)
        {
            try
            {
        ...
        public async Task<ActionResult<ApiResponse<ConditionLog>>> GetConditionLogById(int id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<ApiResponse<IEnumerable<ConditionLog>>>> GetConditionLogsByEquipment(
