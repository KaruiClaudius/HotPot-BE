...
namespace Capstone.HPTY.API.Controllers.Manager
{
    ...
    public class ManagerEquipmentConditionController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<DamageDevice>>> LogEquipmentCondition([FromBody] DamageDevice conditionLog)
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<ApiResponse<IEnumerable<DamageDevice>>>> GetConditionLogsByEquipment(string type, int id)
        {
