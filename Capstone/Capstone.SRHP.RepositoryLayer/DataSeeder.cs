...
namespace Capstone.HPTY.RepositoryLayer
{
    public class DataSeeder
    {
        public static void SeedData(ModelBuilder modelBuilder)
        {
            ...
            // Ingredient Package
            SeedIngredientPackaging(modelBuilder);
        ...
        private static void SeedIngredientPackaging(ModelBuilder modelBuilder)
        {
            // broth - ml
            for (int i = 17; i <= 20; i++) // Ingredients 1-3
            {
                modelBuilder.Entity<IngredientPackaging>().HasData(
