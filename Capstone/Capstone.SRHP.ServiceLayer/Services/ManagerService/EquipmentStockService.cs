...
namespace Capstone.HPTY.ServiceLayer.Services.ManagerService
{
    public class EquipmentStockService : IEquipmentStockService
    {
        ...
        //    public async Task<HotPotInventory> UpdateHotPotInventoryAsync(int inventoryId, HotpotStatus isAvailable, string reason)
        //    {
        ...
        //    #endregion
        //}
        public Task<IEnumerable<HotPotInventory>> GetAllHotPotInventoryAsync()
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Utensil>> GetAllUtensilsAsync()
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<EquipmentStatusDto>> GetEquipmentStatusSummaryAsync()
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<HotPotInventory>> GetHotPotInventoryByHotpotIdAsync(int hotpotId)
        {
            throw new NotImplementedException();
        }

        public Task<HotPotInventory> GetHotPotInventoryByIdAsync(int inventoryId)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Utensil>> GetLowStockUtensilsAsync(int threshold = 5)
        {
            throw new NotImplementedException();
        }

        public Task<Utensil> GetUtensilByIdAsync(int utensilId)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Utensil>> GetUtensilsByTypeAsync(int typeId)
        {
            throw new NotImplementedException();
        }

        public Task<Utensil> UpdateUtensilQuantityAsync(int utensilId, int quantity)
        {
            throw new NotImplementedException();
        }

        public Task<Utensil> UpdateUtensilStatusAsync(int utensilId, bool isAvailable, string reason)
        {
            throw new NotImplementedException();
        }
    }
